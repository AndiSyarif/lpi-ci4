            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form class="needs-validation" novalidate action="/employee" method="POST" enctype="multipart/form-data">
                            <?= csrf_field() ?>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="id" class="form-control <?= session('errors.id') ? 'is-invalid' : '' ?>" id="id" placeholder="ID Employee" value="<?= old('id') ?>" required>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="phone" class="form-control <?= session('errors.phone') ? 'is-invalid' : '' ?>" id="phone" placeholder="Phone" value="<?= old('phone') ?>" required>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="position" class="form-control <?= session('errors.position') ? 'is-invalid' : '' ?>" id="position" placeholder="Position" value="<?= old('position') ?>" required>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="join_date" class="form-control <?= session('errors.join_date') ? 'is-invalid' : '' ?>" id="join_date" placeholder="Join Date" value="<?= old('join_date') ?>" required>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="salary" class="form-control <?= session('errors.salary') ? 'is-invalid' : '' ?>" id="salary" placeholder="Salary" value="<?= old('salary') ?>" required>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="address" id="address" class="form-control <?= session('errors.address') ? 'is-invalid' : '' ?>" cols="100%" rows="5" required><?= old('address') ?></textarea>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div id="img-prev">
                                                <img class="img-preview img-fluid rounded" width="200px" height="200px">
                                            </div>
