        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <?php if ($userImage) : ?>
                            <img src="<?= base_url('img/user/' . $userImage) ?>" class="img-circle elevation-2" alt="User Image">
                        <?php else : ?>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="/setting/<?= $userID ?>/edit" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link log-out" style="color: red;">
